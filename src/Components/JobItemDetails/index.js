...
import {BsLinkExternal} from 'react-icons/bi'
...
class JobItemDetails extends Component {
  ...
  getJobData = async () => {
    ...
    if  (response.ok === true) {
      ...
      console.log(updatedSimilarJobDta)
      this.setState({
        jobData: updatedData,
...
renderJobDetailsView = () => {
  ...
  return (
    <div className= "job-details-view-container">
      <div className="job-item">
        <div className="logo-title-location-container">
          ...
          <div className="location-package-container">
            <div clasName="location-employee-container">
      ...
      <ul className="similar-jobs-heading">Similar Jobs</ul>
